...
import com.ira.formation.dto.RefreshTokenRequestDTO;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponseDTO> refresh(@RequestBody RefreshTokenRequestDTO request) {
        ...
        RefreshToken refreshToken = refreshTokenService
                .getRefreshTokenByToken(request.getRefreshToken())
        ...
        String newAccessToken =
                jwtService.generateToken(refreshToken.getUtilisateur().getEmail());
